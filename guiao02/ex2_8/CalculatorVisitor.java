...
public interface CalculatorVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitStatPrint(CalculatorParser.StatPrintContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ExprPowers}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprPowers(CalculatorParser.ExprPowersContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CalculatorParser#frac}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFrac(CalculatorParser.FracContext ctx);
}