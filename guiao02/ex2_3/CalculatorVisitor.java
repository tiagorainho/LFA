...
public interface CalculatorVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code ExprIntegerMinus}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprIntegerMinus(CalculatorParser.ExprIntegerMinusContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ExprIntegerPlus}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprIntegerPlus(CalculatorParser.ExprIntegerPlusContext ctx);
}