...
public class CalculatorParser extends Parser {
	...
	public static class ExprIntegerMinusContext extends ExprContext {
		public Token sig;
		public TerminalNode Integer() { return getToken(CalculatorParser.Integer, 0); }
		public ExprIntegerMinusContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterExprIntegerMinus(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitExprIntegerMinus(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitExprIntegerMinus(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprIntegerPlusContext extends ExprContext {
		public Token sig;
		public TerminalNode Integer() { return getToken(CalculatorParser.Integer, 0); }
		public ExprIntegerPlusContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterExprIntegerPlus(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitExprIntegerPlus(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitExprIntegerPlus(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case Integer:
				...
				setState(20);
				((ExprIntegerContext)_localctx).sig = match(Integer);
				}
				break;
			case T__4:
				{
				_localctx = new ExprIntegerMinusContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(21);
				((ExprIntegerMinusContext)_localctx).sig = match(T__4);
				setState(22);
				match(Integer);
				}
				break;
			case T__3:
				{
				_localctx = new ExprIntegerPlusContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(23);
				((ExprIntegerPlusContext)_localctx).sig = match(T__3);
				setState(24);
				match(Integer);
				}
				break;
	...
	public static final String _serializedATN =
		...
		"\2\2\23\24\7\13\2\2\24\5\3\2\2\2\25\26\b\4\1\2\26 \7\n\2\2\27\30\7\7\2"+
		"\2\30 \7\n\2\2\31\32\7\6\2\2\32 \7\n\2\2\33\34\7\b\2\2\34\35\5\6\4\2\35"+
		"\36\7\t\2\2\36 \3\2\2\2\37\25\3\2\2\2\37\27\3\2\2\2\37\31\3\2\2\2\37\33"+
		"\3\2\2\2 )\3\2\2\2!\"\f\b\2\2\"#\t\2\2\2#(\5\6\4\t$%\f\7\2\2%&\t\3\2\2"+
		"&(\5\6\4\b\'!\3\2\2\2\'$\3\2\2\2(+\3\2\2\2)\'\3\2\2\2)*\3\2\2\2*\7\3\2"+
