...
public class CalculatorParser extends Parser {
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, null, "VAR", "Integer", 
			"NEWLINE", "WS", "COMMENT"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__2) | (1L << T__6) | (1L << VAR) | (1L << Integer) | (1L << NEWLINE))) != 0)) {
				{
				{
				setState(8);
				stat();
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__2) | (1L << T__6) | (1L << VAR) | (1L << Integer))) != 0)) {
					{
					setState(16);
					expr(0);
					}
	...
	public static final String _serializedATN =
		...
		"#*\7\f\2\2$*\7\13\2\2%&\7\t\2\2&\'\5\b\5\2\'(\7\n\2\2(*\3\2\2\2) \3\2"+
